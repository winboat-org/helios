...
//! of `ddi/start_device.rs` by T8/R1102. Co-locating `init_vsync`,
//! `cancel_vsync` and `vsync_dpc_routine` is the point: `init_vsync` arms the
//! KTIMER with the routine and `cancel_vsync` owns the free-after-DPC contract
