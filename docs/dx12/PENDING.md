...
has itself drifted** · `AGENTS.md`'s vkd3d entry went stale **a fourth time**, inside this
...
* ✅ **PAID** — `kmd_render/src/virtio/gpu/mod.rs` carried a `#[cfg(test)] mod present_stream_tests`
  ...
  fence bridge now depends on. A AGENTS.md invariant violated in-tree. Moved, with the pure helpers,
